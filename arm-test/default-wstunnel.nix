let
  ...
  haskellNix = import (builtins.fetchTarball https://github.com/the-blockchain-company/haskell.nix/archive/angerman/ea554b79a2973790fe8297a70daec266e3859734.tar.gz) {};
